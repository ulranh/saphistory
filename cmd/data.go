...
func (env envInfo) getTransactions() []transaction {
	...
	transactions = append(transactions,
		[]transaction{
			...
			transaction{
				"SM37",
				[]string{"Name", "Job Nr.", "Step Nr.", "Pl. Date", "Pl. Time", "User", "St. Date", "St. Time", "Status", "Client", "WP", "Server"},
				"RFC_READ_TABLE",
				map[string]interface{}{
					"QUERY_TABLE": "TBTCO",
					"DELIMITER":   "|",
			...
			transaction{
				"SM13",
				[]string{"Client", "Username", "Report", "Tcode", "RC", "Server", "State", "Date"},
				"RFC_READ_TABLE",
				map[string]interface{}{
					"QUERY_TABLE": "VBHDR",
					"DELIMITER":   "|",
			...
			transaction{
				"SM58",
				[]string{"Transaction Id", "Target System", "Status", "FuMo", "RC", "Time", "Date", "Caller", "Transaction", "Host", "Reserv"},
				"RFC_READ_TABLE",
				map[string]interface{}{
			...
			transaction{
				"WE02",
				[]string{"IDoc", "Status", "Direction", "Port", "Partner Type", "Basic Type", "Created On", "Created at", "Msg Type", "Extension", "Segments"},
				"RFC_READ_TABLE",
				map[string]interface{}{
					"QUERY_TABLE": "EDIDC",
					"DELIMITER":   "|",
